...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-400': darkMode === true }">
    <!-- ===== Page Wrapper Start ===== -->
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen sm:p-0 dark:bg-gray-900 lg:flex-row">
            <!-- Form -->
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto ">
                    <div>
                        ...
                        @if (session('success'))
                            <div
                                style="margin-bottom: 1rem; background-color: #d1fae5; border: 1px solid #34d399; color: #065f46; padding: 1rem; border-radius: 0.5rem;">
                                {{ session('success') }}
                            </div>
                        @endif
                        ...
                        @if (session('error'))
                            <div
                                style="margin-bottom: 1rem; background-color: #fee2e2; border: 1px solid #f87171; color: #991b1b; padding: 1rem; border-radius: 0.5rem;">
                                {{ session('error') }}
                            </div>
                        @endif
                        ...
                        @if ($errors->any())
                            <div
                                style="margin-bottom: 1rem; background-color: #fee2e2; border: 1px solid #f87171; color: #991b1b; padding: 1rem; border-radius: 0.5rem;">
                                <ul style="padding-left: 1.25rem; list-style-type: disc; font-size: 0.875rem;">
                                    @foreach ($errors->all() as $error)
                                        <li>{{ $error }}</li>
                                    @endforeach
                                </ul>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'"
                                            placeholder="Masukkan kata sandi" type="password" name="password" id="password" 
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'"
                                            placeholder="Masukkan kata sandi"  type="password" name="password_confirmation" id="password_confirmation" 
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                                        <span @click="showPassword = !showPassword"
                                            class="absolute z-30 text-gray-500 -translate-y-1/2 cursor-pointer right-4 top-1/2 dark:text-gray-400">
                                            <svg x-show="!showPassword" class="fill-current" width="20"
                                ...
                                <div class="mt-5 flex flex-col items-start">
                                    <p class="text-sm font-normal text-gray-700 dark:text-gray-400">
                                        Mengalami kendala? Silakan hubungi Admin:
                                    </p>
                        ...
                        <p class="text-sm text-start text-gray-600 mt-6">
                            Sudah punya akun? <a href="{{ route('login') }}"
                                class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Masuk di sini</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                class="hidden md:block relative items-center w-full h-full bg-brand-950 dark:bg-brand-9 lg:grid lg:w-1/2">
