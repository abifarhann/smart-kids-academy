                ...
                <div
                    ...
                    <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-end">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                            ...
                            <form method="GET" action="{{ route('nilai-semester') }}" class="w-full sm:w-auto">
                                <div class="relative">
                            ...
                            {{-- fitur filter data --}}
                            <x-btn-filter :tingkatPendidikanList="$tingkatPendidikanList" :programList="$programList" :tahunAjarList="$tahunAjarList" :action="route('nilai-semester')"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="12" class="text-center text-gray-500 py-6">
                                            Tidak ada data siswa dengan raport semester.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
