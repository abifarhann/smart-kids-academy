<!-- Breadcrumb Start -->
<div x-data="{ pageName: 'Update Akun Admin' }">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <nav class="flex items-center gap-2 text-gray-500 dark:text-gray-400">
            <ol class="flex items-center gap-1.5 text-sm">
                ...
                <!-- Admin -->
                <li>
                    <a href="#" class="flex items-center gap-1.5 text-gray-500 dark:text-gray-400">
                        Autentifikasi
                        <svg class="stroke-current" width="17" height="16" viewBox="0 0 17 16" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
    ...
    <form method="POST" action="{{ route('update-admin', $admin->id) }}">
        ...
        <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
            <div>
                ...
                <input type="text" placeholder="Masukkan nama admin" name="name"
            ...
            <div x-data="{ showPassword1: false }" class="relative mb-4">
                ...
                <span @click="showPassword1 = !showPassword1"
                    class="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400"
            ...
            <div class="pt-4 text-right">
                <button type="button"
                    onclick="setTimeout(() => window.location.href = '{{ route('statistik') }}', 1000);"
