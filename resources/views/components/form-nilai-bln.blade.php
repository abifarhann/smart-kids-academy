...
<form class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div x-data="{ mapelList: [{ mapel: '', nilai: '' }] }" class="space-y-4">
            ...
            <template x-for="(item, index) in mapelList" :key="index">
                <div class="w-full flex flex-col md:flex-row items-start md:items-center gap-4">
                    <!-- Mata Pelajaran -->
                    <div class ="w-full md:w-1/2 flex justify-between sm:flex-col items-start md:items-center gap-4">
                        <div class="w-full md:w-1/2">
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Program Bimbel
                            </label>
                            <div class="relative z-20 bg-transparent">
                                <select x-model="item.mapel" aria-placeholder="Pilih Mata Pelajaran"
                    ...
                    <div class="my-10 md:my-8">
                        <button type="button" @click="mapelList.splice(index, 1)"
                            class="px-3 py-2 rounded-md border border-red-300 text-red-500 hover:bg-red-50 dark:border-red-600 dark:hover:bg-red-800"
                            x-show="mapelList.length > 1">
            ...
            <div>
                <button type="button" @click="mapelList.push({ mapel: '', nilai: '' })"
                    class="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-300 text-gray-700 bg-transparent hover:bg-gray-100 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-800">
    ...
    {{-- btn --}}
    <x-btn-form-nilai-bln class="my-6" />
    </div>
</form>
