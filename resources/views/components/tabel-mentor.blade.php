                ...
                <div
                    ...
                    <div class="flex flex-col gap-5 px-6 mb-4 sm:flex-row sm:items-center sm:justify-end">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                            ...
                            <form method="GET" action="{{ route('data-mentor') }}" class="w-full sm:w-auto">
                                <div class="relative">
                            ...
                            {{-- fitur filter data --}}
                            <x-btn-filter :tingkatPendidikanList="$tingkatPendidikanList" :programList="$programList" action="{{ route('data-mentor') }}" />
                                ...
                                @forelse ($dataMentor as $mentor)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap">
                                            ...
                                            @else
                                                <p
                                                    class="bg-error-50 text-error-600 dark:bg-error-500/10 dark:text-error-500 rounded-full px-2 py-0.5 text-theme-xs font-medium">
                                                    Lulus
                                                </p>
                                            @endif
                                        </td>
                    ...
                    {{-- pagination --}}
                    <x-pagination :paginator="$dataMentor"/>
                    <!-- Table Four -->
                </div>
            </div>
        </div>
